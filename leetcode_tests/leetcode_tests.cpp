// leetcode_tests.cpp : Defines the entry point for the console application.
//
...
{
	/*SolutionTest5Palindromic test;
	//string teststr  = "abbabdabbba";
	//string teststr = "aaaabaaa";
	string teststr = "";

	std::string foundPalindrome = test.longestPalindrome(teststr);*/

	test2_add_two_numbers test;
	...
	//string num1Str = "342";
	//string num2Str = "465";
	//ListNode * num1Parent = new ListNode(2);
	//ListNode * num2Parent = new ListNode(5);

	//[9]
	//[1,9,9,9,9,9,9,9,9,9]
	//string num1Str = "9";
	//string num2Str = "9999999991";
	//ListNode * num1Parent = new ListNode(9);
	//ListNode * num2Parent = new ListNode(1);
	...
	string num2Str = "9";
	ListNode * num1Parent = new ListNode(9);
	ListNode * num2Parent = new ListNode(9);*/
	...
	/*string num1Str = "9998999982";
	string num2Str = "218";
	ListNode * num1Parent = new ListNode(2);
	ListNode * num2Parent = new ListNode(8);*/

	//[7,3,9,4,1,6,7,6,4]
	//[9,4,5,9,7,4,0,6,8,1]

	/*string num1Str = "467614937";
	string num2Str = "1860479549";
	ListNode * num1Parent = new ListNode(7);
	ListNode * num2Parent = new ListNode(9);
	...
	const char *num1 = num1Str.c_str();
	const char *num2 = num2Str.c_str();

	num1++;
	num2++;

	test.convertNumberToList(num1,num1Parent);
	test.convertNumberToList(num2,num2Parent);

	ListNode * final =  test.addTwoNumbers(num1Parent,num2Parent);*/
	...
	/*string beginWord = "hit"; //n.b. the word isn't in the set !
	string endWord = "cog";

	beginWord = "sand";
	endWord = "acne";
	wordList.clear();
	int stringarraylen = sizeof(words)/sizeof(words[0]);
	for(int i=0; i < stringarraylen; ++i)
	{
		wordList.insert(words[i]);
	}

	test127_wordladder _test127_wordladder;
	int shortest = _test127_wordladder.ladderLength(beginWord,endWord,wordList);*/
